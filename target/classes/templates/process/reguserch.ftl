		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr class="rile two">
					...
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">实习天数</label></td>
					<td colspan="4" ><div class="bottom">${(map.tianshu)!''}天</div></td>
				</tr>
				
				<tr class="top">
					<td colspan="14" class="wi "><div class="bottom" ><label class="control-label font">建议及理解</label></div></td>
				</tr>
				
				<tr class="rile" style="height:70px;">
					<td colspan="14"  >
						<div  class="out" style="height:501px;">
							<table class="table ob ">
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
											<p style="height:20px;"></p>
											<span>试用期/实习期心得体会</span>
										</div>
									</td>
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.experience)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
											<p style="height:20px;"></p>
											<span>对本岗位职员的要求的理解</span>
										</div>
									</td>
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.understand)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
											<p style="height:20px;"></p>
											<span>试用期/实习期在哪些方面有了成长</span>
										</div>
									</td>
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.pullulate)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
									...
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.deficiency)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
											<p style="height:20px;"></p>
											<span>如何在本岗位作得更好</span>
										</div>
									</td>
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.dobetter)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
											<p style="height:20px;"></p>
											<span>对公司产品的意见及建议</span>
										</div>
									</td>
									<td colspan="13" style="border-bottom: 1px solid #ddd;"><p style="margin-top: 20px;font-size:16px;">${(eve.advice)!''}</p></td>
								</tr>
								<tr>
