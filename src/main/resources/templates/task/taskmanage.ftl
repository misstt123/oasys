					...
					<table class="table table-hover table-striped">
						<tr>
												...
												<tr>
													...
													<td>
														<a title="修改" href="edittask" class="label label-primary"><span class="glyphicon glyphicon-edit"></span> 修改</a>
														<a title="查看" href="seetask" class="label label-primary"><span class="glyphicon glyphicon-search"></span> 查看</a>
														<a title="删除" href="##" onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');};"  class="label label-primary label-danger"><span class="glyphicon glyphicon-remove"></span> 删除</a>
