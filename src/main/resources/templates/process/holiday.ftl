...
${(out.typeColor)!''}
				...
				<tr >
					...
					<td  colspan="6"><input type="text" class="form-control inpu shi"  name="proId.startTime"/></td>
					<td class="title" ><label class="control-label">结束日期</label></td>
					<td  colspan="6"><input type="text" class="form-control inpu shi" name="proId.endTime"/></td>
				</tr>
					<tr >
