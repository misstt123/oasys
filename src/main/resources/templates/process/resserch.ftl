		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr class="rile two">
					...
					<td  style="width:170px;"><div class="bottom">${eve.handUser.userName}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">费用情况</label></td>
					<td colspan="10" >
					<#if eve.finish==true>
						<span class="labels">
							<label><input type="checkbox" name="cancel" class="val" checked><i>✓</i></label></span>
								<#else>
						<span class="labels">
							<label><input type="checkbox" name="cancel" class="val"><i>✓</i></label></span>
					</#if>
					</td>
						...
						<div  class="out" style="height: 250px;">
							<table class="table ob ">
								...
								<tr>
									...
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.financialAdvice)!''}</p></td>
								</tr>
								<tr>
									<td style="width:130px;text-align:center;background-color:#6d9eeb;">
										<div class="mon">
